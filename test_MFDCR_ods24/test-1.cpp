  ...
  for(j=1; j<commodity+1; ++j){
    ...
    if( no_continuous == 0 ){
      ...
      //if( slvrEXACT->has_var_solution() ){
        ...
        //std::cout << "LAGRANGIAN GAP: " << (slvrEXACT->get_ub()-slvrLD->get_lb())/slvrLD->get_ub() << "\n";
        //std::cout << "CONTINUOUS GAP: " << (slvrEXACT->get_ub()-slvrCONT->get_lb())/slvrCONT->get_ub() << "\n";

        //std::cout << "OPTIMAL CPU TIME: " << time_elapsed_exact << "\n";
        //std::cout << "LAGRANGIAN RELAX CPU TIME: " << time_elapsed_lagrangian << "\n";
        //std::cout << "CONTINUOUS RELAX CPU TIME: " << time_elapsed_continuous << "\n\n";
